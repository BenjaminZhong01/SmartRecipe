...
The program is used to clean invalid data in recipe_name_raw.xls(contains recipe name, amount, unit and ingredidents)
...
This program requires to run an existed file named "recipe_name_raw.xls"
and will eventually create a new file named "recipe_name_clean1.csv"
...
# load the excel file
rb = xlrd.open_workbook('recipe_name_raw.xls')
...
# save the file
wb.save('recipe_name_clean1.csv')