...
if __name__ == '__main__':
    ...
    fout = open('reciperaw.txt','a', encoding='utf-8')
    time = 0
    for i in websites:
        scrapeInstruction(i)
        scrapeIngredients(i)
    ...
    ingredientsdf.to_csv('cleaned_ingredient.csv', index=None,
                         header=True, encoding="utf-8-sig")
    instructionsdf.to_csv('recipe_instruction_try.csv',
